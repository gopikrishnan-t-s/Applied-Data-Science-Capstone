...
The SpaceX launch success prediction project was the capstone project for the IBM Data Science Professional Certificate course. The goal of the project was to determine if the first stage booster of the SpaceX Falcon 9 rocket would successfully land. This project utilized:
